// Mac McCoy
// August 31, 2026 (always update to current)
// variables1.cpp (file name)
// This program will demonstrate declaring and using basic C++ variable types. (short description of the program for easy recall)
...
// 2. Compile: g++ variables1.cpp -o variables1
// 3. Run: ./variables1
...
//    g++ variables1.cpp -o variables1 && ./variables1
