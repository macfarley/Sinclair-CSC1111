...
int main() {
    ...
    cout << "During this term, " << currentTerm << ", I am registered for the following courses:" << endl;
    ...
    cout << "I had also planned on taking " << bis1230 << " and " << math1450 << " during "
         ...
         << " are worth " << bis1230Credits << " and " << math1450Credits << " credits respectively." << endl;
